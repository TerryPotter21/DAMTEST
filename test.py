...
# Set the end and start dates for the data
...
# Display the top tickers for each sector
st.write(sector_best_tickers_reset[['Sector', 'Ticker', 'Alt Ticker']])

# Fetch the sector weightings for SPY ETF (optional)
# Add the sector weightings section if required (optional)
